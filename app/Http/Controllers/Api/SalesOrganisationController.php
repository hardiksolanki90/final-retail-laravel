...
use App\Repositories\SalesOrganisationRepository;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;
use Illuminate\Routing\Controllers\HasMiddleware;

class SalesOrganisationController extends Controller implements HasMiddleware
{
    protected $repository;

    public function __construct(SalesOrganisationRepository $repository)
    {
    ...
    {
        return permissionMiddleware('sales-organisation');
    }
